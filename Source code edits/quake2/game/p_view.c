...
newanim:
	...
	{	// standing
		if (duck)
		{
			ent->s.frame = FRAME_crstnd01; //s.frame start frame
			client->anim_end = FRAME_crstnd19; //client anim_end end anim frame
		}
		else
		{
...
void ClientEndServerFrame (edict_t *ent)
{
	...
	else if (ent->groundentity) //groundentity checks if on ground
